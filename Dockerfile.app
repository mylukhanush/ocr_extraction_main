...
#CMD ["uvicorn", "fastapi_app:app1", "--host", "0.0.0.0", "--port", "8000", "--workers", "4"]
#CMD ["gunicorn", "fastapi_app:app1", "-k", "uvicorn.workers.UvicornWorker", "--bind", "0.0.0.0:8000", "--workers", "2", "--timeout", "120"]
